...
export default function EventsPage() {
  ...
  const generalEvents = [
    { name: "Brain Bids 2.0", description: "Knowledge is your currency, strategy is your edge-bid smart, rise higher!",  registerLink: "https://unstop.com/p/brainbids-20-impetus-250-university-visvesvaraya-college-of-engineering-uvce-bangalore-1416828", image: "images/brainbids.jpeg" },
    { name: "Escape Room: UVCE Edition", description: "Think you have what it takes to solve puzzles under pressure? Test your problem-solving skills in this UVCE-themed escape room! Dive into challenging puzzles, tricky decoding tasks, and hidden clues. Crack complex ciphers and unravel the mystery before time runs out. Each puzzle will test your logic, creativity, and teamwork.", registerLink: "https://unstop.com/p/escape-room-uvce-edition-impetus-250-university-visvesvaraya-college-of-engineering-uvce-bangalore-1416863", image: "images/escape.jpeg" },
    { name: "IPL Auction", description: "The IPL Auction at IMPETUS 25.0 brings an exciting blend of strategy, competition, and real world IPL dynamics ⚡. From the IPL Knockout Quiz to the Panel Auction and Mega Auction, teams will battle through intense bidding wars, player selections, and strategic retention to emerge as champions!", registerLink: "https://unstop.com/p/ipl-auction-impetus-250-university-visvesvaraya-college-of-engineering-uvce-bangalore-1416870", image: "images/ipl.jpeg"},
    { name: "Synthetic Intelligence", description: "Master the art of prompt engineering and AI optimization to tackle a mind-bending, logic-twisting challenge! Research, refine, and submit within the given time—creativity, logic, and AI mastery will set you apart. This single-round event will test your ability to crack a tricky problem involving contradictions and numerical reasoning using GPT-4, Claude, Gemini and etc. Your approach, prompt quality, and AI model choice will decide the winner!  ", registerLink: "https://unstop.com/p/synthetic-intelligence-impetus-250-university-visvesvaraya-college-of-engineering-uvce-bangalore-1416876", image: "images/synth.jpeg" },
    ...
    { name: "DATA QUEST", description: "An event by GDSC...", registerLink: "https://unstop.com/p/dataquest-impetus-250-university-visvesvaraya-college-of-engineering-uvce-bangalore-1416839", image: "/images/dataquest1.jpg" },
    {
